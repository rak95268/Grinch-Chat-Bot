...
const API_KEY = "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"; // Paste your API key here
...
const handleChat = () => {
    ...
    setTimeout(() => {
        ...
        const incomingChatLi = createChatLi("Stealing Christmas cheer...", "Bah humbug!");
